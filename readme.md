...
The system compares a KPI against a historical baseline and uses statistical thresholds to identify meaningful movements.
...
Normal variation is separated from potentially material movement.
...
The prototype combines quantitative KPI information with qualitative evidence such as:
...
The engine identifies a mismatch between:

* Google Ads attribution
* Salesforce attribution

and refuses to generate an unsupported causal explanation.
